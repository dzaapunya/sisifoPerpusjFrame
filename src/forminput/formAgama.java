 ...
 * @author Lenovo
 */
public class formAgama extends javax.swing.JFrame {
    public Statement st;
    public ResultSet rs;
    ...
    private void initComponents() {
        ...
        kdAgama = new javax.swing.JTextField();
        ...
        jLabel1.setText("INPUT AGAMA");

        jLabel2.setText("Kode Agama");

        jLabel3.setText("Nama Agama");
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                .addGroup(layout.createSequentialGroup()
                                    ...
                                    .addGap(67, 67, 67)
                                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addComponent(namaAgama, javax.swing.GroupLayout.PREFERRED_SIZE, 165, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addComponent(kdAgama, javax.swing.GroupLayout.PREFERRED_SIZE, 165, javax.swing.GroupLayout.PREFERRED_SIZE)))
                                .addGroup(layout.createSequentialGroup()
    ...
    private void btnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSimpanActionPerformed
        ...
        try {
            st = conn.createStatement();
            if(kdAgama.getText().equals("") || namaAgama.getText().equals("")){
                JOptionPane.showMessageDialog(this, "Data Tidak Boleh Kosong!", "Warning", JOptionPane.WARNING_MESSAGE);
            }
            else{
                rs = st.executeQuery("SELECT * FROM agama where kode = '" + kdAgama.getText() + "'");
                if(rs.next()){
                    JOptionPane.showMessageDialog(this, "Prodi Sudah Ada!", "Data Duplikat", JOptionPane.WARNING_MESSAGE);
                    
                }else{
                    String input = "INSERT INTO agama VALUES (NULL, '" + kdAgama.getText() + "', '" + namaAgama.getText() + "')";
    ...
    private void btnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditActionPerformed
        // TODO add your handling code here:
        try {
            String sql = "UPDATE agama set kode = '" + kdAgama.getText() + 
                    "', nama='" + namaAgama.getText() + "' WHERE kode = '" + kdAgama.getText() + "'";
    ...
    private void btnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHapusActionPerformed
        ...
        if(kdAgama.getText().equals("")){
            ...
            if (jawab == 0) {
                try {
                    st = conn.createStatement();
                    String sql = "DELETE FROM agama WHERE kode='"+ kdAgama.getText() + "'";
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        kdAgama.setText(kode);
        String nama = jTable1.getValueAt(baris, 1).toString();
        namaAgama.setText(nama);
        kdAgama.setEditable(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(formAgama.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JTextField kdAgama;
